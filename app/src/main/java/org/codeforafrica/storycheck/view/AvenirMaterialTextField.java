 ...
 */
public class AvenirMaterialTextField extends FrameLayout {
    ...
    protected void handleAttributes(Context context, AttributeSet attrs) {
        try {
            ...
            {
                cardColor = styledAttrs.getColor(com.github.florent37.materialtextfield.R.styleable.MaterialTextField_mtf_cardColor, -1);
            }
            {
    ...
    public AvenirMaterialTextField(Context context) {
        super(context);
    }

    public AvenirMaterialTextField(Context context, AttributeSet attrs) {
        super(context, attrs);
        handleAttributes(context,attrs);
    }

    public AvenirMaterialTextField(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        card = (CardView) findViewById(com.github.florent37.materialtextfield.R.id.mtf_card);
    ...
    public void reduce() {
        if (expanded) {
            ...
            ValueAnimator expand = ValueAnimator.ofInt(card.getHeight(), getContext().getResources().getDimensionPixelOffset(com.github.florent37.materialtextfield.R.dimen.mtf_cardHeight_initial));
    ...
    public void expand() {
        if (!expanded) {
            ...
            ValueAnimator expand = ValueAnimator.ofInt(0, getContext().getResources().getDimensionPixelOffset(com.github.florent37.materialtextfield.R.dimen.mtf_cardHeight_final));
            expand.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    Integer value = (Integer) animation.getAnimatedValue();
